/**
 * Tipos, constantes y helpers puros del catálogo. Este módulo lo importan
 * tanto Server Components como Client Components, así que NO puede tocar
 * `@/lib/supabase/server` (arrastra `next/headers`, que no existe en el
 * bundle del cliente). Las consultas viven en `./catalogo.server`.
 */
